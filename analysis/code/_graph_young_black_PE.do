...
gen hom_rate_young_black = taxa_homicidios_negro_jovem_por_
...
twoway (rcap ci_upper_2007 ci_lower_2007 rel_year if rel_year >= -7 & rel_year <= 12, lcolor(navy)) ///
	 ...
	 graph export "/Users/Fredie/Documents/GitHub/PublicSecurity/analysis/output/graphs/young_black_event_study_PE.pdf", replace
...
twoway (rcap ci_upper_2007_trend ci_lower_2007_trend rel_year if rel_year >= -6 & rel_year <= 12, lcolor(navy)) ///
	   ...
	   graph export "/Users/Fredie/Documents/GitHub/PublicSecurity/analysis/output/graphs/young_black_event_study_PE_trends.pdf", replace
