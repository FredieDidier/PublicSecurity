...
* Primeira regressão
eststo: reg taxa_homicidios_total_por_100m_1 pe_post ba_pb_post ce_post ma_post pe_did ba_pb_did ce_did ma_did pe_treat ba_pb_treat ce_treat ma_treat i.municipality_code i.year [weight=population_2000_muni], cluster(state_code) nocons
...
eststo: reg taxa_homicidios_total_por_100m_1 pe_post ba_pb_post ce_post ma_post pe_did ba_pb_did ce_did ma_did pe_treat ba_pb_treat ce_treat ma_treat i.municipality_code i.year log_population [weight=population_2000_muni], cluster(state_code) nocons
