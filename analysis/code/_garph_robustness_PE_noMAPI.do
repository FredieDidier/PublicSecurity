...
boottest {t_7_2007} {t_6_2007} {t_5_2007} {t_4_2007} {t_3_2007} {t_2_2007} {t_1_2007} ///
        ...
        {t_7_2015} {t_6_2015} {t_5_2015} {t_4_2015} {t_3_2015} {t_2_2015} {t_1_2015} ///
        {t1_2015} {t2_2015} {t3_2015} {t4_2015}, ///
        noci nograph cluster(state_code) reps(9999) weighttype(webb) seed(982638)
...
cap file close f1
file open f1 using "/Users/fredie/Documents/GitHub/PublicSecurity/analysis/output/tables/event_study_robustness_PE_noMAPI.tex", write replace
...
twoway (rcap ci_upper_2007 ci_lower_2007 rel_year if rel_year >= -7 & rel_year <= 12, lcolor(navy)) ///
	 ...
	 graph export "/Users/Fredie/Documents/GitHub/PublicSecurity/analysis/output/graphs/robustness_event_study_PE_noMAPI.pdf", replace
...
twoway (rcap ci_upper_2007_trend ci_lower_2007_trend rel_year if rel_year >= -6 & rel_year <= 12, lcolor(navy)) ///
	   ...
	   graph export "/Users/Fredie/Documents/GitHub/PublicSecurity/analysis/output/graphs/robustness_event_study_PE_trends_noMAPI.pdf", replace
